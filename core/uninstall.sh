...
uninstall_show_menu() {
    ...
    printf '\n'
    ui_primary_line '1. 卸载 STermux'
    ui_secondary_line '   包含程序、配置、日志及所有备份'
    printf '\n'
    ui_primary_line '2. 卸载 SillyTavern'
    ui_secondary_line '   删除当前酒馆及其中的用户数据'
    printf '\n'
    ui_primary_line '3. 删除所有 SillyTavern 备份'
    printf '\n'
    ui_primary_line '4. 删除自动进入配置'
    printf '\n'
    ui_primary_line '0. 返回'
    printf '\n'
    ui_separator
